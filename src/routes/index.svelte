...
{#each publicFonts as font, index}
    <section>
        ...
        <a href={`${import.meta.env.BASE_URL}fonts/${encodeURIComponent(font.category)}/${encodeURIComponent(font.name)}.fnt`} download>
          <img
            src={`${import.meta.env.BASE_URL}previews/${font.category}/${font.name}.png`}
